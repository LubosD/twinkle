...
#define PIDF_STATUS_USER_ONLINE		"ready"
#define PIDF_STATUS_USER_OFFLINE	"unavailable"
#define PIDF_STATUS_USER_TALKING	"on the phone"
#define PIDF_STATUS_USER_RINGING	"ringing"
...
private:
	...
	string		user_status;	/**< Vaue if note-tag */
	...
	/**
	 * Process userstatus (note tag) element.
